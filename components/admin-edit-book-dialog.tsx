...
interface AdminEditBookDialogProps {
  open: boolean
...
export function AdminEditBookDialog({ open, onOpenChange, book, onEditBook }: AdminEditBookDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Update the details of the book in the library inventory.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
